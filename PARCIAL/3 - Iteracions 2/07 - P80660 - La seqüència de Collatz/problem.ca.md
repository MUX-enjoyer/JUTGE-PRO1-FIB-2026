...
exemple, començant en 3, s'obté la seqüència
$$3,~ 10,~ 5,~ 16,~ 8,~ 4,~ 2,~ 1 .$$
...
problema no us en demanarem una demostració, només que feu un programa
que escrigui quants passos triga a arribar a 1 cada $n$ donada.
...
Per a cada $n$, escriviu quants passos es triga a arribar a 1. Suposeu
que aquest nombre està ben definit, és a dir, que la conjectura de
l'enunciat és certa.
