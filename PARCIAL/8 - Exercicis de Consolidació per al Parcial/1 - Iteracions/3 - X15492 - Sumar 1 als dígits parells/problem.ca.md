...
Escriviu un programa que llegeix nombres d'entrada, i els torna a
escriure després d'haver sumat 1 a aquells dígits que fossin parells.

Per exemple, el programa transformarà el nombre `785902` en `795913`.
...
Per a cada cas, la sortida té una línia amb el corresponent nombre
resultant de sumar 1 als dígits que siguin parells.
